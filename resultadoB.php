...
include("resultotis.php");
include("resultepq.php");
//$cod ="0010";
...
	
	$consul="SELECT * FROM tb_resultadosb WHERE idaspirante='$cod' AND prueba_num='$num_prue';";
	...
	{
		if($diagotis=="NA" || $diagnosticoepq=="NA")
		{
			$dfinal="R";
		}
		else
		...
		if($_SESSION[testotis]==false && $_SESSION[testepq]==false) 
		{
$sql = "INSERT INTO tb_resultadosb(idaspirante,ciotis,dotis,cepq_n,cepq_e,cepq_p,cepq_s,depq,dfinal,prueba_num) VALUES('$cod','$ciotis','$diagotis','$centilepq_n','$centilepq_e','$centilepq_p','$centilepq_s','$diagnosticoepq','$dfinal','$num_prue');";
...
$tex0='El suscrito encargado del realizar la Prueba Psicológica a los aspirantes a estudiar las carreras de PROFESORADO  en la Facultad ';
$tex1=', Ingreso ';
$tex2 = '. CERTIFICA QUE: ';
...
$pdf->SetX(20);
$pdf->Ln(20);
$tex="Se sometió a la Prueba Psicológica de Personalidad e Inteligencia tal como los dispone el Ministerio de Educación.";
$pdf->MultiCell(0,5,$tex);


	$consul="SELECT if(dfinal='A','APTO','NO APTO') as dd FROM tb_resultadosb WHERE idaspirante='$cod' AND prueba_num='$num_prue';";
	//$consul="SELECT if(dfinal='A','SSAPTO','NO ddAPTO') as dd FROM tb_resultadosa WHERE idaspirante='0001' AND prueba_num='2';";
	$result0 = mysql_query($consul, $conexion);
	if($row=mysql_fetch_array($result0))
	{
		$dfinalpdf=$row['dd'];
