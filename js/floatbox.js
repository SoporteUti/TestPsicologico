...
urlGraphics:    '/graphics/'   ,// change this if you install in another folder
urlLanguages:   '/languages/'  ,// change this if you install in another folder
/*** </General Options> ***/
...
init: function() {
	...
	if (!this.isChild) {
		...
		this.strings = {
			...
			hintPlay: 'Iniciar (key: spacebar)',
			hintPause: 'Pausa (key: spacebar)',
			hintResize: 'Resize (key: Tab)',
			imgCount: 'Imagen %1 of %2',
			nonImgCount: 'Pagina %1 of %2',
			mixedCount: '(%1 de %2)',
			infoText: 'Info...',
			printText: 'Imprimir...'
		};
