	...
	<td valign="top">
		<center><br><br>
			...
			<table width="400"><tr><td>
              ...
              <!--Mensaje para advertir sobre la 3ra prueba-->
		<table width="750" border="0"><tr><td>
			<tr><td><center><b><font size="+1"  color="#FF0000">
				LA 3ra PRUEBA ES REALIZA CON AUTORIZACIÓN DE VICEDECANATO
			</b></center></td></tr>
		</table>
        <!--Mensaje para advertir de la 3 prueba fin-->
			 </center>
			</form>
<!--FIN DEL CONTENIDO-->			
		</center>
...
{
	$sqlx="SELECT * FROM tb_auxresultados WHERE num_prue=2 AND idaspirante='$idaspirante';";
	$result3 = mysqli_query($conexion,$sqlx);
	if($row=mysqli_fetch_array($result3))
	{
		$flag=true;
