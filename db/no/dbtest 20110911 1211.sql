...
--
-- Create schema dbtestspsicologico
--

CREATE DATABASE IF NOT EXISTS dbtestspsicologico;
USE dbtestspsicologico;
...
INSERT INTO `tb_admon` (`id`,`nombre`,`sexo`,`tel`,`cargo`,`usu`,`pass`) VALUES 
 (1,'Lic. Jorge Alberto Mena','1','12345678','Psicologo','admin','21232f297a57a5a743894a0e4a801fc3');
