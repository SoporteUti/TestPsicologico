	...
	<td valign="top">
		<center>
			...
			<?php
				...
				if($_POST['prueba']=="A"){$PA="checked";$PB="";$PT="";}else if($_POST['prueba']=="B"){$PA="";$PB="checked";$PT=""; } else if($_POST['prueba']=="T"){$PA="";$PB="";$PT="checked";}
				else{$PA="";$PB="";$PT="";}
...
fclose ($fp);
    ...
    ?>
				...
				<td width="52" rowspan="4"><b>A</b>
				  <input type="radio" name="prueba" value="A" <?php echo $PA; ?> onClick="des(this.form)" class="styled"></td>
				<td width="52" rowspan="4"><b>B</b>
				  <input type="radio" name="prueba" value="B" <?php echo $PB ?> class="styled"></td>
  				<td width="100" rowspan="4"><b>Todo</b>
				  <input type="radio" name="prueba" value="T" <?php echo $PT ?> class="styled"></td>
			</tr>
			<tr>
