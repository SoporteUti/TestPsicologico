	...
	<td valign="top">
		<center>
			...
			<?php
				...
				echo'<tr><td rowspan="5"><img src="img/otis.gif"></td></tr>';
				echo'<tr><td rowspan="5" width="10%"></td></tr>';				
				echo'<tr><td colspan="5"><b>ASPIRANTE: '. strtoupper($nom) .'</td></tr>';
				echo'<tr>';
				echo'<td width="40%" style=" border:1px solid #000000"><b>CI</td>';
$sql="SELECT ciotis FROM resultadosb where idaspirante='$cod' AND  prueba_num='$num_prue';";
...
echo'</table>';
				...
				echo'<table width="20%" border="0" cellspacing="0" cellpadding="0"  class="tabla">';
	           	echo'<tr>';
				...
				echo'<table width="20%" border="0" cellspacing="0" cellpadding="0"  class="tabla">';
$consul='select t1.idotis c1,t2.preguntas c2,t1.respuesta c3 from tb_respotis as t1 inner join tb_otis as t2 on t1.idotis=t2.idotis where t1.idaspirante="'. $cod .'" and t1.idnum_prue="'. $num_prue. '";';
				$result0 = mysql_query($consul, $conexion);
				$i=0;
